...
\subsection{No. of passengers=10000}
\subsubsection{harbour up route}
\begin{table}[h!]
...
\begin{minipage}{.5\textwidth}
  \begin{center}
    ...
    ]{harbourTruUp.csv} % filename/path to file
  \end{center}
  ...
  \begin{center}
    ...
    \pgfplotstabletypeset[
      ...
      every head row/.style={
		...
		every last row/.style={after row=\bottomrule}, % rule at bottom
    ]{harbourEstUp.csv} % filename/path to file
  \end{center}
...
\end{table}
%%down route
\subsubsection{harbour down route}
\begin{table}[h!]
  ...
  \begin{center}
    ...
    \pgfplotstabletypeset[
      ...
      every head row/.style={
		...
		every last row/.style={after row=\bottomrule}, % rule at bottom
    ]{harbourTruDown.csv} % filename/path to file
  \end{center}
  ...
  \begin{center}
    ...
    \pgfplotstabletypeset[
      ...
      every head row/.style={
		...
		every last row/.style={after row=\bottomrule}, % rule at bottom
    ]{harbourEstDown.csv} % filename/path to file
  \end{center}
